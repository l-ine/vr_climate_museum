...
The entire project was developed on Windows systems for Meta Quest VR headsets.

### Unity project

For a detailed description of the project, contact the owner of the repository and ask for her master thesis.

### Data analysis

Run the ... script to generate the descriptive statistics and figures from the dataset.
