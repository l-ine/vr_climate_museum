...
public class RestAPICallTest : MonoBehaviour
{
  ...
  public static void RunFile()
  {
    ...
    //UnityEngine.Debug.Log(UnityEngine.Application.streamingAssetsPath + @"/electron-app-win32-x64/electron-app.exe");
...
// test the connection to Rest-API when museum is started
  ...
  {
    //JsonUtility.ToJson(this._get_result, true);
    //UnityEngine.Debug.Log("this" + JsonUtility.ToJson(this._get_result, true));
...
// is called from EnvironmentUpdate.read&apply()
  public void RunModelAction()
  {
    if (this.ready)
    {
      //UnityEngine.Debug.Log("ready: " + this.ready + ", running: " + this._running);
      if (!this._running)
      {
        //this.GetData();
        UnityEngine.Debug.Log("print before postdata()...");
        this.PostData();
      ...
      else
      {
        ...
        */
        ...
        if (temperatures.Count > 0)
        {
          ...
          UnityEngine.Debug.Log("temp2020: " + temp2020 + ", temp2040: " + temp2040 + ", temp2060: " + temp2060 + ", temp2080: " + temp2080 + ", temp2100: " + temp2100);

            // pass the temperature to EnvironmentUpdate
